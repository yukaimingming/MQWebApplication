...
Log.Information("服务启动：{0}", "Services Starting...");
Log.Information("运行环境: {0}",
    $"MQ接口服务正在运行!!! 请勿随意关闭接口服务，避免造成数据丢失!!! Powered by {RuntimeInformation.FrameworkDescription} 强力驱动 on Kestrel");
